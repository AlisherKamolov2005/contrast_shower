...
class ContrastShowerCycle2 extends ConsumerStatefulWidget {
  const ContrastShowerCycle2({super.key});

  @override
  _ContrastShowerCycle2State createState() => _ContrastShowerCycle2State();
}

class _ContrastShowerCycle2State extends ConsumerState<ContrastShowerCycle2> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Ensure the provided callback is called after the widget has been fully built.
